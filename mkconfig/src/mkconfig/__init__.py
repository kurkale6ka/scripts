...
repos = (
    ...
    RepoData(
        ...
        links=(
            ...
            Link('XDG/bat', env['XDG_CONFIG_HOME']),
            Link('XDG/git', env['XDG_CONFIG_HOME']),
            Link('XDG/ruff', env['XDG_CONFIG_HOME']),
            Link('XDG/wezterm', env['XDG_CONFIG_HOME']),
            Link('XDG/starship.toml', env['XDG_CONFIG_HOME']),
            Link('XDG/stylua.toml', env['XDG_CONFIG_HOME']),
        ),
    ),
    RepoData('help'),
